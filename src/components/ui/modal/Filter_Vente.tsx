...
const Filter_Vente = ({ text, icon }: { text: string; icon: string }) => {
                        ...
                        <div className="ml-2">
                            ...
                            <div className="flex gap-10 pt-8 pb-8">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <button
                                        type="button"
                                        className="text-white bg-[#D9A528] from-purple-600 to-blue-500 rounded-full  
                                         text-[#EBF1FF] border-1 border-[#EBF1FF] px-5 py-2.5 text-center   w-[172px] h-[45px]"
                                    >
                                        Recherche
                                    </button>
                                </div>
