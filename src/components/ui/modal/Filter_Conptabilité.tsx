...
const Filter_Conptabilité = ({ text, icon }: { text: string; icon: string }) => {
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <button
                                        type="button"
                                        className="text-white bg-[#D9A528] from-purple-600 to-blue-500 rounded-full mt-[1.4rem] ml-[20px]
                                         text-[#EBF1FF] border-1 border-[#EBF1FF] px-5 py-2.5 text-center mr-4 mb-[-1rem] w-[172px] h-[45px]"
                                    >
                                        Recherche
                                    </button>
                                </div>
...
export default Filter_Conptabilité;