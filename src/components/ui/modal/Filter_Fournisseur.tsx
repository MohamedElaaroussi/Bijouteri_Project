...
const Filter_Fournisseur = ({ text, icon }: { text: string; icon: string }) => {
                        ...
                        <div className="mr-6">
                            ...
                            <div className="flex gap-10 pt-8 pb-8">
                                ...
                                <div className="flex flex-col ">
                                    <button
                                        type="button"
                                        className="text-white bg-[#D9A528] from-purple-600 to-blue-500 rounded-full ml-7 
...
export default Filter_Fournisseur;