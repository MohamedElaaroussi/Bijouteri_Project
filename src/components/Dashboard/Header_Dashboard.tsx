import Header from '@/app/(file)/utilisateur/USerComponent/Header/Header'
import SearchBar from '@/app/(file)/utilisateur/USerComponent/Header/SearchBar';
...
const Header_Dashboard = () => {
    return (
        <div className="mb-[-40px]  flex  justify-between px-[130px]  ">
            <div className='flex justify-between gap-[18vh]'>
                <div className="pl-4">
                    <span>
                        <h1
                        ...
                        >
                            <span className='trxt-[#4D4D4D] text-[28px] font-semibold font-Inter'>Bienvenue sur</span>
                            <span className='text-[#D9A528] text-[28px] font-semibold'> Marina jewelry</span>
                        </h1>
                    </span>
                </div>
            ...
            <div className="ml-8">
                <div className="flex justify-between gap-4 px-3">
                    ...
                    <span className="ml-6 mr-[-140px] flex">
                        <div>
                            <h4 className="pt-2 font-bold	text-[14px] font-dmsans">Hi Andrei,</h4>
                        </div>
