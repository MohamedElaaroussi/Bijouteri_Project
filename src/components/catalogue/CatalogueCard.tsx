    ...
    <div>
      {
        loading ?
          (
            <div className="ml-[500px] h-[450px] mt-[230px]">
          ...
          !lenCatalogue ?
            ...
            <div>
              <div className='bg-[#FFF] h-[30rem] '>
                <div className=" rounded-lg pl-[44%] pt-[14%]">
                  <Image src={"/search2.svg"} width={130} height={130} alt='Not Found' ></Image>
                </div>
                <p className='text-[#96B0C4] text-center text-[15px] font-normal mt-6'>
                  <h5>Il n'y a pas encore xxxxxxxxxxxx ajouté.</h5><br />
