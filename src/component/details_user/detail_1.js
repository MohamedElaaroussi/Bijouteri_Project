      ...
      <div className=" pt-14  pr-20 flex justify-start pl-8 mt-4">
        ...
        <div>
          <div className="w-[300px] mx-auto h-[210px] bg-white rounded-lg pb-3 shadow-lg">
            ...
            <div className="px-12 pb-0 w-50 ml-10">
              <div className="text-center my-2 pr-10 mt-[-20px] ">
                <div className="h-20 w-20  bg-[#F4F7FE] ml-5 rounded-full overflow-hidden">
                  <span className="text-[#C1C4C7] flex justify-center  text-[30px] font-normal font-medium pt-3.5 ">
                    KH
                  </span>
                </div>
                <div className="py-1  ">
                  ...
                  <div className="inline-flex text-[#787878] items-center">
                    0664-848-484
                  </div>
                </div>
              </div>
              <div className="flex gap-2 pr-4 ">
                <button className="flex-1 justify-center rounded-full bg-[#05CD99] text-white antialiased font-bold  px-4 py-1.5 mr-[50px]">
                  Administrateur
                </button>
              </div>
            </div>
