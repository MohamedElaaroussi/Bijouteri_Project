    ...
    <div className="flex justify-between items-center px-2 ml-4 py-3 sm:px-6">
      <div className="flex flex-1 sm:hidden">
        <a
          ...
          px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 w-20"
        >
          Previous
        </a>
        <a
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between  ">
        ...
        <div className="pr-[200px] ">
          <nav
            className="isolate inline-flex -space-x-px rounded-md shadow-sm" style={{margin:'0px -140px'}}
          ...
          >
            <a
              ...
              py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50
               focus:z-20 focus:outline-offset-0   pl-4"
            >
            ...
            <a
              ...
              className="relative z-10 inline-flex items-center bg-indigo-600 px-4 py-2
               text-sm font-semibold text-white focus:z-20 focus-visible:outline bg-yellow-500
