...
const Section_G = ({email,phone,role}:{email:string,phone:string,role:string}) => {
  return (
    <div>
      <div className="mt-[20px] flex h-screen pt-10 ">
        ...
        <div>
          <div className="mx-auto h-[180px] w-[860px]  rounded-lg bg-white pb-6 shadow-lg ml-12 w-[53.5rem]">
            ...
            <div className="flex h-[20px] justify-between p-4 pr-8 ">
              <h4 className="pl-[1.7rem] text-[#96B0C4]"> Mot de Pass </h4>
            ...
            <div className="flex h-[20px] justify-between p-5 text-[#96B0C4]">
              ...
              <span>
              <Image width={60} height={30} alt="" src={"/Status.svg"}
                ></Image>
              </span>
              <span></span>
            </div>
