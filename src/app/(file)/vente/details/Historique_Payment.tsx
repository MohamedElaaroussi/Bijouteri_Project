...
export default function Historique_Payment() {
    return (
        <>
            <div className="bg-[white] rounded-[17px] w-[22rem] mt-5">
                <div className="text-[#96B0C4] pl-[1.2rem] pt-3 pb-3">Historique de paiement</div>
                <Table className="pl-4 pr-4" removeWrapper aria-label="Example static collection table">
                    <TableHeader >
                    ...
                    <TableBody>
                        <TableRow key="1">
                            <TableCell>
                                ...
                                <h6 className="text-[#C1C4C7] font-2">Sep 15, 2023</h6>
                            </TableCell>
