        ...
        <div className="mb-[42vh] mt-7">
            ...
            >
                ...
                <TableHeader className="bg-[#F7F9FB]">
                    <TableColumn className="text-center w-[5rem]" key={"id"}>ID</TableColumn>
                    <TableColumn className="text-center" key={"image"}>Images</TableColumn>
                    <TableColumn className="text-center" key={"Client"}>Client</TableColumn>
                    <TableColumn className="text-center" key={"Etat"}>Etat</TableColumn>
                    <TableColumn className="text-center" key={"Date"}>Date</TableColumn>
                    <TableColumn className="text-center" key={"poid"}>Poid</TableColumn>
                    <TableColumn className="text-center" key={"total"}>Total</TableColumn>
                                ...
                                <TableCell className="w-[5rem] pb-8">
                                    {
                                        columnKey === "action" ? (
                                            ...
                                            <div className="">
                                                <div className='text-[#D9A528] text-center'>
                                                    {item._id}
                                                </div>
                                            ...
                                            : columnKey === "image" ? (
                                                ...
                                                : columnKey === "Client" ? (
                                                    ...
                                                    : columnKey === "Date" ? (
                                                        <div className="w-[5rem]">{format(new Date(item.date), "yyyy-MM-dd")}</div>)
                                                        : columnKey === "Etat" ? (
                                                            <div>
                                                            ...
                                                            : columnKey === "poid" ? (item.totalWeight)
                                                                : columnKey === "total" ? (item.totalPrice)
                                                                    : (
